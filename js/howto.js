...
function howto() {
  ...
  <p>where the radius r is assumed to be the mean radius of the Earth, 6371.0088 km. <sup>1</sup></p>\
  ...
  <h3>Example</h3>\
  <p>Bern: 7&deg; 27&rsquo; / 46&deg; 57&rsquo; (or 7.45&deg; / 46.95&deg;)<br />\
  Avarua: -159&deg; 47&rsquo; / -21&deg; 12&rsquo; (or -159.78&deg; / -21.20&deg;)</p>\
